...
async def generate_report(
    ...
    existing_report = db.query(AssessmentReport).filter(
        AssessmentReport.session_id == data.session_id
    ).first()
    ...
    if existing_report:
        return ReportResponse(
            ...
            dimension_details=existing_report.dimension_details or {},
            coaching_narrative=existing_report.coaching_narrative or "",
            strengths=existing_report.strengths or [],
            improvement_areas=existing_report.improvement_areas or [],
            action_items=existing_report.action_items or [],
    ...
    return ReportResponse(
        ...
        coaching_narrative=report.coaching_narrative or "",
