...
async def setup_mongodb(url: str = "mongodb://synthhire:localdev123@localhost:27017/synthhire?authSource=admin"):
    ...
    try:
        await db.create_collection("transcripts", validator={
            "$jsonSchema": {
                "bsonType": "object",
                ...
                "properties": {
                    ...
                    "full_transcript_text": {"bsonType": "string"},
                }
            }
        })
    except:
    ...
    await db.emotional_frames.create_index(
        [("created_at", 1)],
    ...
    await db.prosody_analysis.create_index(
        [("created_at", 1)],
