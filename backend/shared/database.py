...
engine = create_engine(_settings.database_url, connect_args={'check_same_thread': False} if 'sqlite' in _settings.database_url else {}, pool_pre_ping=True, pool_recycle=3600)
