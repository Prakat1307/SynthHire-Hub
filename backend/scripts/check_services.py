...
SERVICES = [
    ...
    ("Session Orchestrator", "http://localhost:8003/health"),
    ("Speech Pipeline", "http://localhost:8004/health"),
    ("Code Executor", "http://localhost:8005/health"),
    ("Assessment Engine", "http://localhost:8006/health"),
    ("Emotion Analysis", "http://localhost:8007/health"),
    ("Report Generator", "http://localhost:8009/health"),
    ("Analytics Service", "http://localhost:8010/health"),
]
